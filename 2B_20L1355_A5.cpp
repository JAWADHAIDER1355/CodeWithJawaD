...
int xxxx;
int yyyy;
//ONE TWO VTHREE FOUR ARE VERTICES
int startingrowno;
int startingcolumno;
int endingrowno;
int endingcolumno;
int k;
//ROWZZ AND COLUM ARE ROW AND COLUMNS OF 2D ARRAY(GRID)
int rowzz=0;
int colum=0;
//XYZ IS INTEGER VARIABLE SAVING THE COLUMN NUMBERS OF GRID
int columcounter=0;
using namespace std;
//50 50 ARE JUST IMAGINED WE WILL MAKE EXACT ALLOCATIONS AFTER SAVING IN ONE ARRAY LIKE START
char start[50][50];
char randomupperalphabets()
{
    int c=0;
    char y;
    javi:;
                        ...
                        if(input[a][0]==real[i][j])
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    int xxx=0;
                                    //THIRD CONDITION============================================================
                                    for(xxxx=i;xxxx<i+inputsiz;xxxx++,xxx++)
                                    {
                                        if(input[a][xxx]!=real[xxxx][j])
                                        {
                                            temp=0;
                                        }
                                    }
                          ...
                          //FIFTH CONDITION=============================================================================
                                            ...
                                            for(xxxx=i,yyyy=j;xxxx<i+inputsiz&&yyyy<j+inputsiz;xxxx++,yyyy++,xxx++)
                                            {
                                                if(input[a][xxx]!=real[xxxx][yyyy])
                                                {
                                                    temp=0;
                                                }
                                            }
                                            ...
                                            {
                                                startingrowno=xxxx-inputsiz;
                                                startingcolumno=yyyy-inputsiz;
                                                endingrowno=xxxx-1;
                                                endingcolumno=yyyy-1;
                                                outputfileobj<<"("<<startingrowno<<","<<startingcolumno<<")-----("<<endingrowno<<","<<endingcolumno<<")"<<endl;
                                                goto nextinput;
                                            }
                                            else
